...
public class Krol 
{
     ...
     */
    public int kamien; // liczba kamieni w zasobach
	public int diament; // liczba diamentow w zasobach
	public int drewno; // liczba drewna w zasobach
	public int zloto; //liczba zlota 
